...
function getInstagramMediaByMediaId({
    id,
    file,
    pretty,
    time,
            ...
            request(options, async (error, res, body) => {
                ...
                if (!error && res.statusCode == 200) {
                    ...
                    if (realId) {
                        ...
                        result = await getInstagramUserByUserId({
                            id: realId,
                            file,
                            pretty,
                            time,
...
function getInstagramUserByUserId({
    id,
    file,
    pretty,
    time,
...
function getInstagramMediaByUsername({
    id,
    maxImages,
    file,
    pretty,
...
module.exports = {
    getInstagramMediaByUsername,
    getInstagramUserByUserId,
